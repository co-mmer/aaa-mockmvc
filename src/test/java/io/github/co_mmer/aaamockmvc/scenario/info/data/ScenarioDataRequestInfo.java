package io.github.co_mmer.aaamockmvc.scenario.info.data;
...
import static io.github.co_mmer.aaamockmvc.testdata.testutil.TestValue.TEST_URI_VAR_1;
import static io.github.co_mmer.aaamockmvc.testdata.testutil.TestValue.TEST_URI_VAR_2;
...
import io.github.co_mmer.aaamockmvc.testdata.testutil.TestRequestDtoBuilder;
...
public final class ScenarioDataRequestInfo {
  ...
  public static final TestRequestDto HEAD_REQUEST__HEAD_CONTENT_TYPE_1 =
      TestRequestDtoBuilder.builder()
          .withRequestType(TestRequestType.HEAD)
          .withUri(TEST_URI)
  ...
  public static final TestRequestDto HEAD_REQUEST__HEAD_CONTENT_TYPE_2 =
      TestRequestDtoBuilder.builder()
          .withRequestType(TestRequestType.HEAD)
          .withUri(TEST_URI)
          .withHeadContentType(APPLICATION_JSON)
  ...
  public static final TestRequestDto HEAD_REQUEST__HEAD_ACCEPT_1_CONTENT_TYPE_1 =
      TestRequestDtoBuilder.builder()
          .withRequestType(TestRequestType.HEAD)
          .withUri(TEST_URI)
          .withHeadAccept(APPLICATION_XML)
  ...
  public static final TestRequestDto HEAD_REQUEST__HEAD_AUT_CONTENT_TYPE_1 =
      TestRequestDtoBuilder.builder()
          .withRequestType(TestRequestType.HEAD)
          .withUri(TEST_URI)
          .withHeadKeyValue(TEST_AUTH_KEY, TEST_AUTH_VALUE)
  ...
  public static final TestRequestDto HEAD_REQUEST__HEAD_CONTENT_TYPE_1_KEY_VALUE_1 =
      TestRequestDtoBuilder.builder()
          .withRequestType(TestRequestType.HEAD)
          .withUri(TEST_URI)
          .withHeadContentType(APPLICATION_XML)
  ...
  public static final TestRequestDto HEAD_REQUEST__HEAD_CONTENT_TYPE_1_KEY_VALUE_2 =
      TestRequestDtoBuilder.builder()
          .withRequestType(TestRequestType.HEAD)
          .withUri(TEST_URI)
          .withHeadContentType(APPLICATION_XML)
  ...
  public static final TestRequestDto HEAD_REQUEST__HEAD_CONTENT_TYPE_1_KEY_VALUE_MAP =
      HEAD_REQUEST__HEAD_CONTENT_TYPE_1_KEY_VALUE_2;
}
