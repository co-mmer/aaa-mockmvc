package io.github.co_mmer.aaamockmvc.scenario.delete.data;

import static io.github.co_mmer.aaamockmvc.test.web.request.model.TestRequestType.DELETE;
...
public final class ScenarioDataRequestDelete {
  ...
  public static final TestRequestDto DEL_REQUEST__URI =
      TestRequestDtoBuilder.builder().withRequestType(DELETE).withUri(TEST_URI).build();

  public static final TestRequestDto DEL_REQUEST__URI_VARIABLE =
      TestRequestDtoBuilder.builder().withRequestType(DELETE).withUri(TEST_URI_VAR_1).build();

  public static final TestRequestDto DEL_REQUEST__URI_VARIABLES =
      TestRequestDtoBuilder.builder().withRequestType(DELETE).withUri(TEST_URI_VAR_2).build();
