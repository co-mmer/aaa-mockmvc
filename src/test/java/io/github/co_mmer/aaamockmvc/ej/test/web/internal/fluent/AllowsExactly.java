...
import static io.github.co_mmer.aaamockmvc.ej.test.web.internal.fluent.ApiIntrospector.findPublicMethodByName;
...
public final class AllowsExactly implements Matcher<FluentTransition> {
  ...
  public Optional<String> match(FluentTransition t) {
    Method start = findPublicMethodByName(t.fromClass(), t.startMethod());
    if (start == null) {
      return Optional.of(
