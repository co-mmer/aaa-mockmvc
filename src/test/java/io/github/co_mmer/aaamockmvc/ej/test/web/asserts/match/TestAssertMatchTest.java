  ...
  class withCollection {
    ...
    class matchAll {
      ...
      void GIVEN_A1_A2_match_A_WHEN_assertMatch_THEN_return_true() {
        TestAssertMatch.assertThat(LIST_A1_A2).matchesAll(EQUALS_A);
      }
      ...
      void GIVEN_A1_A2_match_A2_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            ...
            () -> TestAssertMatch.assertThat(LIST_A1_A2).matchesAll(EQUALS_A, EQUALS_2));
      }
    }
    ...
    class matchAny {
      ...
      void GIVEN_A1_A2_match_1_WHEN_assertMatch_THEN_return_true() {
        TestAssertMatch.assertThat(LIST_A1_A2).matchesAny(EQUALS_1);
      }

      @Test
      void GIVEN_A1_A2_match_A_WHEN_assertMatch_THEN_return_true() {
        TestAssertMatch.assertThat(LIST_A1_A2).matchesAny(EQUALS_A);
      }
      ...
      void GIVEN_A1_A2_match_B_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            AssertionError.class,
            () -> TestAssertMatch.assertThat(LIST_A1_A2).matchesAny(EQUALS_B));
      }
    }
    ...
    class matchNone {
      ...
      void GIVEN_A1_A2_match_B_WHEN_assertMatch_THEN_return_true() {
        TestAssertMatch.assertThat(LIST_A1_A2).matchesNone(EQUALS_B);
      }
      ...
      void GIVEN_A1_A2_match_A_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            AssertionError.class,
            () -> TestAssertMatch.assertThat(LIST_A1_A2).matchesNone(EQUALS_A));
      }
      ...
      void GIVEN_A1_A2_match_1_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            AssertionError.class,
            () -> TestAssertMatch.assertThat(LIST_A1_A2).matchesNone(EQUALS_1));
      }
      ...
      void GIVEN_A1_A2_match_A2_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            AssertionError.class,
            () -> TestAssertMatch.assertThat(LIST_A1_A2).matchesNone(EQUALS_A, EQUALS_2));
      }
    }
  }
  ...
  class withObject {
    ...
    class matchAll {
      ...
      void GIVEN_A1_match_A_WHEN_assertMatch_THEN_return_true() {
        TestAssertMatch.assertThat(A1).matchesAll(EQUALS_A);
      }
      ...
      void GIVEN_A1_match_A2_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            AssertionError.class,
            () -> TestAssertMatch.assertThat(A1).matchesAll(EQUALS_A, EQUALS_2));
      }
    }
    ...
    class matchAny {
      ...
      void GIVEN_A1_match_1_WHEN_assertMatch_THEN_return_true() {
        TestAssertMatch.assertThat(A1).matchesAny(EQUALS_1);
      }

      @Test
      void GIVEN_A1_match_A_WHEN_assertMatch_THEN_return_true() {
        TestAssertMatch.assertThat(A1).matchesAny(EQUALS_A);
      }

      @Test
      void GIVEN_A1_match_B_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            AssertionError.class, () -> TestAssertMatch.assertThat(A1).matchesAny(EQUALS_B));
      }
    }
    ...
    class matchNone {
      ...
      void GIVEN_A1_match_B_WHEN_assertMatch_THEN_return_true() {
        TestAssertMatch.assertThat(A1).matchesNone(EQUALS_B);
      }

      @Test
      void GIVEN_A1_match_A_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            AssertionError.class, () -> TestAssertMatch.assertThat(A1).matchesNone(EQUALS_A));
      }

      @Test
      void GIVEN_A1_match_1_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            AssertionError.class, () -> TestAssertMatch.assertThat(A1).matchesNone(EQUALS_1));
      }
      ...
      void GIVEN_A1_match_A2_WHEN_assertMatch_THEN_throw_AssertionError() {
        assertThrows(
            AssertionError.class,
            () -> TestAssertMatch.assertThat(A1).matchesNone(EQUALS_A, EQUALS_2));
      }
    }
  }
}
