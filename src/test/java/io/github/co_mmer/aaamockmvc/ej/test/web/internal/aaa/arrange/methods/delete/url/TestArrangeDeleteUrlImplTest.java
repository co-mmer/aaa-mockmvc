package io.github.co_mmer.aaamockmvc.ej.test.web.internal.aaa.arrange.methods.delete.url;
...
import io.github.co_mmer.aaamockmvc.ej.test.web.internal.aaa.arrange.methods.delete.header.TestArrangeDeleteHeaderImpl;
...
class TestArrangeDeleteUrlImplTest {
  ...
  void setUp() {
    ...
    this.impl = new TestArrangeDeleteUrlImpl(this.context, BASE_PATH);
  }
  ...
  class headers {
    ...
    void WHEN_headers_THEN_returnExpectedClass() {
      ...
      // Assert
      assertThat(headers.getClass(), is(TestArrangeDeleteHeaderImpl.class));
    }
  }
}
