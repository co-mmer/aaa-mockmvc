package io.github.co_mmer.aaamockmvc.ej.scenario.res;

import static org.hamcrest.MatcherAssert.assertThat;
import static org.hamcrest.Matchers.is;
import static org.mockito.ArgumentMatchers.eq;

import io.github.co_mmer.aaamockmvc.ej.scenario.res.data.ScenarioDataActPost;
import io.github.co_mmer.aaamockmvc.ej.scenario.res.data.ScenarioDataPost;
...
class ScenarioResTest {
  ...
  void setUp() {
    ...
    this.mockTestRequestStrategyFactory
        .when(() -> TestRequestStrategyFactory.resolve(TestRequestType.POST))
  ...
  void GIVEN_useCase_WHEN_perform_THEN_return_expected_data(
    ...
    this.mockTestRequestStrategyFactory.verify(
        () -> TestRequestStrategyFactory.resolve(eq(TestRequestType.POST)));
