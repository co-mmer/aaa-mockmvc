...
class TestArrangeOptionsUrlImplTest {

  private TestAAAContext context;
  private TestArrangeOptionsUrlImpl impl;
  ...
  void setUp() {
    ...
    this.impl = new TestArrangeOptionsUrlImpl(this.context, TEST_URL);
  }
  ...
  class constructor {
    ...
    void GIVEN_provideNullOnContextUrl_WHEN_call_constructor_THEN_throwException(
      ...
      assertThrows(NullPointerException.class, () -> new TestArrangeOptionsUrlImpl(context, url));
    }
    ...
    void GIVEN_url_WHEN_arrangeUrl_THEN_setUriIsCalled() {
      ...
      mockTestArrangeUrlUtils.verify(
          () -> setUri(context.getArrangeResult().getUrl(), OPTIONS, TEST_URL));
    }

    @Test
    void GIVEN_pathWithVariable_WHEN_call_constructor_THEN_setUriIsCalled() {
      // Act
      new TestArrangeOptionsUrlImpl(context, TEST_PATH_VAR1, VAR_STRING_1);

      // Assert
      mockTestArrangeUrlUtils.verify(
          () -> setUri(context.getArrangeResult().getUrl(), OPTIONS, TEST_PATH_VAR1, VAR_STRING_1));
    }
    ...
    void GIVEN_provideNullOnContextUri_WHEN_call_constructor_THEN_throwException(
      ...
      assertThrows(NullPointerException.class, () -> new TestArrangeOptionsUrlImpl(context, uri));
    }
    ...
    void GIVEN_uri_WHEN_call_constructor_THEN_setUriIsCalled() {
      // Act
      new TestArrangeOptionsUrlImpl(context, TEST_URI);

      // Assert
      mockTestArrangeUrlUtils.verify(
          () -> setUri(context.getArrangeResult().getUrl(), OPTIONS, TEST_URI));
    }
  }
  ...
  class headers {
    ...
    void WHEN_headers_THEN_returnExpectedClass() {
      ...
      // Assert
      assertThat(headers.getClass(), is(TestArrangeOptionsHeaderImpl.class));
    }
  }
}
