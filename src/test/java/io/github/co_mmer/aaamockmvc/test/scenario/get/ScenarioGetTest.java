package io.github.co_mmer.aaamockmvc.test.scenario.get;
...
import io.github.co_mmer.aaamockmvc.test.scenario.get.data.ScenarioDataActGet;
import io.github.co_mmer.aaamockmvc.test.scenario.get.data.ScenarioDataGet;
...
class ScenarioGetTest {
  ...
  private static Stream<Arguments> useCaseHead() {
    return Stream.of(
        Arguments.of(ScenarioDataActGet.GET_ARRANGE__PARAM_KEY_VALUE_1__HEAD),
        Arguments.of(ScenarioDataActGet.GET_ARRANGE__PARAM_KEY_VALUE_2__HEAD),
        Arguments.of(ScenarioDataActGet.GET_ARRANGE__PARAM_KEY_VALUE_MAP__HEAD));
  }
}
