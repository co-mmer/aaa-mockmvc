package io.github.co_mmer.aaamockmvc.test;

import static io.github.co_mmer.aaamockmvc.testdata.testutil.TestDataMockMvc.MOCK_MVC;
...
import io.github.co_mmer.aaamockmvc.testdata.Application;
...
class AAAMockMvcTest {
  ...
  void WHEN_call_constructor_mockMvc_THEN_return_not_null() {
    // Act
    var aaaMockMvcDefaultObjectMapper = new AAAMockMvc(MOCK_MVC);
  ...
  void WHEN_call_constructor_mockMvc_ObjectMapper_THEN_return_not_null() {
    // Act
    var aaaMockMvcObjectMapper = new AAAMockMvc(MOCK_MVC, new ObjectMapper());
