...
class TestRequestHeadTest extends TestRequestBase {

  @InjectMocks private TestRequestHead testRequestHead;
  ...
  void WHEN_arrange_THEN_TestRequestContext_is_called_with_dto() {
    ...
    assertThat(capturedTestRequestDTO.getType(), Matchers.is(TestRequestType.HEAD));
  }
}
