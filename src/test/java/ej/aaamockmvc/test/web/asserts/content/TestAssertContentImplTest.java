...
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECTS_2_DTO;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECTS_LIST_1_JSON;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECTS_MAP_1_DTO;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECTS_MAP_1_JSON;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECTS_MAP_2_DTO;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECTS_MAP_2_JSON;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECTS_SET_1_DTO;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECTS_SET_1_JSON;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECTS_SET_2_DTO;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECT_1_DTO;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECT_1_JSON;
import static ej.aaamockmvc.test.testdata.testutil.TestObject.TEST_OBJECT_2_DTO;
