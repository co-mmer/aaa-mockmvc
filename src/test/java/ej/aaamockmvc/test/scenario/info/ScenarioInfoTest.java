package ej.aaamockmvc.test.scenario.info;
...
import ej.aaamockmvc.test.scenario.info.data.ScenarioDataActInfo;
import ej.aaamockmvc.test.scenario.info.data.ScenarioDataInfo;
