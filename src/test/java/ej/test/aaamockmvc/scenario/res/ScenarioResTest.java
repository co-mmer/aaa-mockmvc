package ej.test.aaamockmvc.scenario.res;
...
import ej.test.aaamockmvc.scenario.res.data.ScenarioDataActPost;
import ej.test.aaamockmvc.scenario.res.data.ScenarioDataPost;
