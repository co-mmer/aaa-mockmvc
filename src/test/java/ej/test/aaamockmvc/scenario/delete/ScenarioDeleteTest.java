package ej.test.aaamockmvc.scenario.delete;
...
import ej.test.aaamockmvc.scenario.delete.data.ScenarioDataActDelete;
import ej.test.aaamockmvc.scenario.delete.data.ScenarioDataDelete;
