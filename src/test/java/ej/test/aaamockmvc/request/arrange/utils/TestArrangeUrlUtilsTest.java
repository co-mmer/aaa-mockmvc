...
import static ej.test.aaamockmvc.testdata.testutil.TestParameter.TEST_PARAM_KEY_0;
...
import static ej.test.aaamockmvc.testdata.testutil.TestParameter.TEST_PARAM_VALUE_0;
...
import static ej.test.aaamockmvc.testdata.testutil.TestValue.TEST_PATH_VARIABLE_2;
import static ej.test.aaamockmvc.testdata.testutil.TestValue.TEST_PATH_VARIABLE_3;
import static ej.test.aaamockmvc.testdata.testutil.TestValue.TEST_PATH_VARIABLE_6;
import static ej.test.aaamockmvc.testdata.testutil.TestValue.TEST_URI;
import static ej.test.aaamockmvc.testdata.testutil.TestValue.VAR_BOOLEAN_TRUE;
import static ej.test.aaamockmvc.testdata.testutil.TestValue.VAR_CHAR_1;
import static ej.test.aaamockmvc.testdata.testutil.TestValue.VAR_DOUBLE_1;
import static ej.test.aaamockmvc.testdata.testutil.TestValue.VAR_FLOAT_1;
import static ej.test.aaamockmvc.testdata.testutil.TestValue.VAR_INT_1;
