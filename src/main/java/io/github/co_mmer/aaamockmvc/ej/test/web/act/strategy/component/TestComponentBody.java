package io.github.co_mmer.aaamockmvc.ej.test.web.act.strategy.component;
...
public final class TestComponentBody {
  ...
  private static void applyContent(
    ...
    if (TestRequestDtoUtils.isNotNullContent(requestBodyDto)) {
  ...
  private static void applyFile(
    ...
    if (TestRequestDtoUtils.isNotEmptyFiles(requestBodyDto)) {
