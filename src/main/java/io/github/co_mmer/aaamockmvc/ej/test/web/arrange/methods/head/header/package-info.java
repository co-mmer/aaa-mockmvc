/**
 * Arrange-phase for configuring HTTP headers on HEAD requests.
 *
 * <p><b>Scope:</b> Provides a fluent API to define request headers ({@code Authorization}
 * and arbitrary custom headers) for a pending HEAD request. Header names are treated
 ...
 * {@link io.github.co_mmer.aaamockmvc.ej.test.web.arrange.methods.head.header.TestArrange1HeadHeader}.
 *
 * @since 1.0.0
 */
