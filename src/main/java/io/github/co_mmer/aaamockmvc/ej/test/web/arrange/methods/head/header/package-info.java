 ...
 * arbitrary custom headers) for a pending HEAD request. Header names are treated
 ...
 * io.github.co_mmer.aaamockmvc.ej.test.web.arrange.methods.head.header.TestArrange1HeadHeader}.
 *
 * @since 1.0.0
 */
