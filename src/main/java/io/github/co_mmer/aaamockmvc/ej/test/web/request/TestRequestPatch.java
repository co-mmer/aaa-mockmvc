...
import io.github.co_mmer.aaamockmvc.ej.test.web.arrange.res.url.TestArrange1ResUrl;
import io.github.co_mmer.aaamockmvc.ej.test.web.arrange.res.url.TestArrangeResUrlImpl;
...
public final class TestRequestPatch extends TestRequestBase {
  ...
  public TestArrange1ResUrl arrange() {
    var context = super.createContext(TestRequestType.PATCH);
