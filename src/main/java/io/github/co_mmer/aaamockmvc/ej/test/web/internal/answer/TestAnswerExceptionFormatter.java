...
public final class TestAnswerExceptionFormatter {
  ...
  public static String createMessage(
    ...
    return """
        ...
        """
        .formatted(createStep(step), stepName, content, simpleName);
  }
  ...
  public static String createMessage(
    ...
    return """
        ...
        """
        .formatted(createStep(step), stepName, content, keySimpleName, valueSimpleName);
  }

  private static String createStep(TestStepDto step) {
    return step == null ? EMPTY : reasonOf(step) + "\n";
  }
}
