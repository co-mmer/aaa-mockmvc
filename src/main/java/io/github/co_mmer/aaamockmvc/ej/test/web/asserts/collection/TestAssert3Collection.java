 ...
 *
 * <ul>
 *   <li>{@link #assertCollectionMatchAll(Class, Predicate)}: Validating that all elements in the collection match a specific condition.</li>
 *   <li>{@link #assertCollectionMatchAny(Class, Predicate)}: Ensuring that at least one element in the collection matches a specified condition.</li>
 *   <li>{@link #assertCollectionMatchNone(Class, Predicate)}: Asserting that none of the elements in the collection match a specific condition.</li>
