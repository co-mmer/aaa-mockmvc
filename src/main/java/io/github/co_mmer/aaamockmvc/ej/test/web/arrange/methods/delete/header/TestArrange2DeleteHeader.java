 ...
 * @since 1.0.0
 */
public interface TestArrange2DeleteHeader {
   ...
   * @since 2.0.0
   */
  TestArrange3DeleteHeader auth(String token);
   ...
   * @since 2.0.0
   */
  TestArrange5DeleteHeader add(String key, Object value);
   ...
   * @since 2.0.0
   */
  TestArrange6DeleteHeader set(@NonNull Map<String, List<Object>> keyValue);
}
