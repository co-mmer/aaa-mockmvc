/**
 * Arrange-phase for configuring HTTP headers on GET requests.
 *
 * <p><b>Scope:</b> Provides a fluent API to define request headers ({@code Accept}, {@code
 * Authorization}, and arbitrary custom headers) for a pending GET request. Header names are treated
 ...
 * io.github.co_mmer.aaamockmvc.ej.test.web.arrange.methods.get.header.TestArrange1GetHeader}.
 *
 * @since 1.0.0
 */
