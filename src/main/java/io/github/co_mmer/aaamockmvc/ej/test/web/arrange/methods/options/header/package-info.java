/**
 * Arrange-phase for configuring HTTP headers on OPTIONS requests.
 *
 * <p><b>Scope:</b> Provides a fluent API to define request headers ({@code Authorization}
 * and arbitrary custom headers) for a pending OPTIONS request. Header names are treated
 * case-insensitively, and multi-value headers are supported. These steps mutate only the request
 ...
 * {@link io.github.co_mmer.aaamockmvc.ej.test.web.arrange.methods.options.header.TestArrange1OptionsHeader}.
 *
 * @since 1.0.0
 */
