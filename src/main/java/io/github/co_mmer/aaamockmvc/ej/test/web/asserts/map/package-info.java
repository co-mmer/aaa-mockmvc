 ...
 *
 * <p><b>Scope:</b> Provides size, emptiness, and equality checks on maps obtained via {@code
 * content().asMap(K,V)}. The response body has already been deserialized once using the configured
