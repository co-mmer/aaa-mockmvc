...
public final class TestAssertResultMapper {
   ...
   * @throws NullPointerException if the {@code result} or {@code expectedClass} is {@code null}
   ...
   * @throws NullPointerException if the {@code result}, {@code keyClass}, or {@code valueClass} is
   *     {@code null}
   * @throws TestAssertResultMapperException if an error occurs during mapping
   * @since 1.0.0
   */
