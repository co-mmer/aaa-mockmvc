package ej.aaamockmvc.test.web.arrange.res.url;
...
import ej.aaamockmvc.test.web.arrange.res.head.TestArrange1ResHead;
import ej.aaamockmvc.test.web.arrange.res.head.TestArrangeResHeadImpl;
import ej.aaamockmvc.test.web.arrange.res.param.TestArrange1ResParam;
...
public final class TestArrangeResUrlImpl extends TestArrangeBaseUrl
  ...
  /**
   * Initializes the arrangement for PATCH/POST/PUT request URLs using the provided
